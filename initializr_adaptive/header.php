    ...
    <body <?php body_class(); ?>>
        ...
        <div class="header-container">
            <header class="wrapper clearfix">
                ...
                <nav id="access">
                <h3 class="assistive-text"><?php _e( 'Main menu', 'initializr_adaptive' ); ?></h3>
                <?php /* Allow screen readers / text browsers to skip the navigation menu and get right to the good stuff. */ ?>
                <div class="skip-link"><a class="assistive-text" href="#content" title="<?php esc_attr_e( 'Skip to primary content', 'initializr_adaptive' ); ?>"><?php _e( 'Skip to primary content', 'initializr_adaptive' ); ?></a></div>
                <div class="skip-link"><a class="assistive-text" href="#secondary" title="<?php esc_attr_e( 'Skip to secondary content', 'initializr_adaptive' ); ?>"><?php _e( 'Skip to secondary content', 'initializr_adaptive' ); ?></a></div>
